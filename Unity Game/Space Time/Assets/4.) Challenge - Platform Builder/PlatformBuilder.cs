...
{
    float hornLength = 15.44f;
    float rodLength = 82.24f; // 0.) *** Replace the 0 with the length of your rods here
    ...
    void Start()
    {
        ...
        basePoints[0] = new Vector3(-19.65f,-56.24f,0.0f);
        basePoints[1] = new Vector3(19.65f,-56.24f,0.0f);
        basePoints[2] = new Vector3(58.53f,11.10f,0.0f);
        basePoints[3] = new Vector3(38.88f,45.14f,0.0f);
        basePoints[4] = new Vector3(-38.88f,45.14f,0.0f);
        basePoints[5] = new Vector3(-58.53f,11.10f,0.0f);

        // 2.) *** fill in all 6 values with your values from solidworks
        platformPoints = new Vector3[6];
        platformPoints[0] = new Vector3(-41.26f,-37.01f,0.0f);
        platformPoints[1] = new Vector3(41.26f,-37.01f,0.0f);
        platformPoints[2] = new Vector3(52.68f,-17.22f,0.0f);
        platformPoints[3] = new Vector3(11.43f,54.24f,0.0f);
        platformPoints[4] = new Vector3(-11.43f,54.24f,0.0f);
        platformPoints[5] = new Vector3(-52.68f,-17.22f,0.0f);
