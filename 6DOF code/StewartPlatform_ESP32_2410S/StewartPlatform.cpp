...
void StewartPlatform::DefineBasePoints()
{
    ...
    basePoints[0] = {-19.65f,-56.24f,0.0f};
    basePoints[1] = {19.65f,-56.24f,0.0f};
    basePoints[2] = {58.53f,11.10f,0.0f};
    basePoints[3] = {38.88f,45.14f,0.0f};
    basePoints[4] = {-38.88f,45.14f,0.0f};
    basePoints[5] = {-58.53f,11.10f,0.0f};
...
void StewartPlatform::DefinePlatformPoints()
{
    ...
    platformPoints[0] = {-41.26f,-37.01f,0.0f};
    platformPoints[1] = {41.26f,-37.01f,0.0f};
    platformPoints[2] = {52.68f,-17.22f,0.0f};
    platformPoints[3] = {11.43f,54.24f,0.0f};
    platformPoints[4] = {-11.43f,54.24f,0.0f};
    platformPoints[5] = {-52.68f,-17.22f,0.0f};
